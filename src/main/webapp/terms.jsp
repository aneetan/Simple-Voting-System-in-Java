...
<html>
<head>
    <title> Terms and Condiiton </title>
</head>
<body>
    ...
    <ul>
        <li>
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named VoteNow</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to VoteNow.</p>
        </li>
        <li>
    ...
    <ul>
        <li>By email: votenow@gmail.com</li>
    </ul>
</body>
</html>
